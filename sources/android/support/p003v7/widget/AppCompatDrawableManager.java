...
public final class AppCompatDrawableManager {
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int resId) {
        ...
        if (resId == C0176R.C0177drawable.abc_cab_background_top_material) {
            dr = new LayerDrawable(new Drawable[]{getDrawable(context, C0176R.C0177drawable.abc_cab_background_internal_bg), getDrawable(context, C0176R.C0177drawable.abc_cab_background_top_mtrl_alpha)});
        }
        if (dr != null) {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int resId, boolean failIfNotKnown, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            return drawable2;
        } else if (resId == C0176R.C0177drawable.abc_seekbar_track_material) {
            LayerDrawable ld = (LayerDrawable) drawable;
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0176R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0176R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0176R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        } else if (resId == C0176R.C0177drawable.abc_ratingbar_material || resId == C0176R.C0177drawable.abc_ratingbar_indicator_material || resId == C0176R.C0177drawable.abc_ratingbar_small_material) {
            LayerDrawable ld2 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0176R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0176R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0176R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
    ...
    static boolean tintDrawableUsingColorFilter(@NonNull Context context, @DrawableRes int resId, @NonNull Drawable drawable) {
        ...
        if (arrayContains(COLORFILTER_TINT_COLOR_CONTROL_NORMAL, resId)) {
            colorAttr = C0176R.attr.colorControlNormal;
            colorAttrSet = true;
        } else if (arrayContains(COLORFILTER_COLOR_CONTROL_ACTIVATED, resId)) {
            colorAttr = C0176R.attr.colorControlActivated;
            colorAttrSet = true;
        } else if (arrayContains(COLORFILTER_COLOR_BACKGROUND_MULTIPLY, resId)) {
            colorAttr = 16842801;
            colorAttrSet = true;
            tintMode = PorterDuff.Mode.MULTIPLY;
        } else if (resId == C0176R.C0177drawable.abc_list_divider_mtrl_alpha) {
            colorAttr = 16842800;
            colorAttrSet = true;
            alpha = Math.round(40.8f);
        } else if (resId == C0176R.C0177drawable.abc_dialog_material_background) {
            colorAttr = 16842801;
            colorAttrSet = true;
        }
        if (!colorAttrSet) {
    ...
    static PorterDuff.Mode getTintMode(int resId) {
        if (resId == C0176R.C0177drawable.abc_switch_thumb_material) {
    ...
    public ColorStateList getTintList(@NonNull Context context, @DrawableRes int resId) {
        return getTintList(context, resId, (ColorStateList) null);
    }
    ...
    public ColorStateList getTintList(@NonNull Context context, @DrawableRes int resId, @Nullable ColorStateList customTint) {
        ...
        if (tint == null) {
            if (resId == C0176R.C0177drawable.abc_edit_text_material) {
                tint = AppCompatResources.getColorStateList(context, C0176R.color.abc_tint_edittext);
            } else if (resId == C0176R.C0177drawable.abc_switch_track_mtrl_alpha) {
                tint = AppCompatResources.getColorStateList(context, C0176R.color.abc_tint_switch_track);
            } else if (resId == C0176R.C0177drawable.abc_switch_thumb_material) {
                tint = AppCompatResources.getColorStateList(context, C0176R.color.abc_tint_switch_thumb);
            } else if (resId == C0176R.C0177drawable.abc_btn_default_mtrl_shape) {
                tint = createDefaultButtonColorStateList(context, customTint);
            } else if (resId == C0176R.C0177drawable.abc_btn_borderless_material) {
                tint = createBorderlessButtonColorStateList(context, customTint);
            } else if (resId == C0176R.C0177drawable.abc_btn_colored_material) {
                tint = createColoredButtonColorStateList(context, customTint);
            } else if (resId == C0176R.C0177drawable.abc_spinner_mtrl_am_alpha || resId == C0176R.C0177drawable.abc_spinner_textfield_background_material) {
                tint = AppCompatResources.getColorStateList(context, C0176R.color.abc_tint_spinner);
            } else if (arrayContains(TINT_COLOR_CONTROL_NORMAL, resId)) {
                tint = ThemeUtils.getThemeAttrColorStateList(context, C0176R.attr.colorControlNormal);
            } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, resId)) {
                tint = AppCompatResources.getColorStateList(context, C0176R.color.abc_tint_default);
            } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, resId)) {
                tint = AppCompatResources.getColorStateList(context, C0176R.color.abc_tint_btn_checkable);
            } else if (resId == C0176R.C0177drawable.abc_seekbar_thumb_material) {
                tint = AppCompatResources.getColorStateList(context, C0176R.color.abc_tint_seek_thumb);
            }
    ...
    private ColorStateList createDefaultButtonColorStateList(@NonNull Context context, @Nullable ColorStateList customTint) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0176R.attr.colorButtonNormal), customTint);
    }
    ...
    private ColorStateList createColoredButtonColorStateList(@NonNull Context context, @Nullable ColorStateList customTint) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0176R.attr.colorAccent), customTint);
    }
    ...
    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int baseColor, @Nullable ColorStateList tint) {
        ...
        int colorControlHighlight = ThemeUtils.getThemeAttrColor(context, C0176R.attr.colorControlHighlight);
        int disabledColor = ThemeUtils.getDisabledThemeAttrColor(context, C0176R.attr.colorButtonNormal);
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        if (!this.mHasCheckedVectorDrawableSetup) {
            ...
            Drawable d = getDrawable(context, C0176R.C0177drawable.abc_vector_test);
