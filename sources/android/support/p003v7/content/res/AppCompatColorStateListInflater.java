    ...
    private static ColorStateList inflate(@NonNull Resources r, @NonNull XmlPullParser parser, @NonNull AttributeSet attrs, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (type == 1 || ((depth = parser.getDepth()) < innerDepth && type == 3)) {
                ...
                TypedArray a = obtainAttributes(r, theme, attrs, C0176R.styleable.ColorStateListItem);
                int baseColor = a.getColor(C0176R.styleable.ColorStateListItem_android_color, -65281);
                float alphaMod = 1.0f;
                if (a.hasValue(C0176R.styleable.ColorStateListItem_android_alpha)) {
                    alphaMod = a.getFloat(C0176R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (a.hasValue(C0176R.styleable.ColorStateListItem_alpha)) {
                    alphaMod = a.getFloat(C0176R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                a.recycle();
                int j2 = 0;
                ...
                while (true) {
                    ...
                    if (stateResId == 16843173 || stateResId == 16843551 || stateResId == C0176R.attr.alpha) {
                        j2 = j;
                    } else {
                        j2 = j + 1;
