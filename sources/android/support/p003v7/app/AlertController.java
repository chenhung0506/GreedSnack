...
class AlertController {
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes((AttributeSet) null, C0176R.styleable.AlertDialog, C0176R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0176R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0176R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0176R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0176R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0176R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0176R.styleable.AlertDialog_listItemLayout, 0);
        a.recycle();
    ...
    private void setupView() {
        View spacer;
        View parentPanel = this.mWindow.findViewById(C0176R.C0178id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0176R.C0178id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0176R.C0178id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0176R.C0178id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0176R.C0178id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0176R.C0178id.topPanel);
        View customContentPanel = customPanel.findViewById(C0176R.C0178id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0176R.C0178id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null || (spacer = contentPanel.findViewById(C0176R.C0178id.textSpacerNoButtons)) == null)) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0176R.C0178id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0176R.C0178id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0176R.C0178id.custom);
