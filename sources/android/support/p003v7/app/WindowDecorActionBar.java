...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        boolean homeAsUp;
        boolean z;
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0176R.C0178id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0176R.C0178id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0176R.C0178id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0176R.C0178id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes((AttributeSet) null, C0176R.styleable.ActionBar, C0176R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0176R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0176R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0176R.attr.actionBarWidgetTheme, outValue, true);
